...
// 	protoc        v7.36.0
// source: cspb/activity/ack.proto
...
func (x *GetActivityListAck) Reset() {
	*x = GetActivityListAck{}
	mi := &file_cspb_activity_ack_proto_msgTypes[0]
...
func (*GetActivityListAck) Descriptor() ([]byte, []int) {
	return file_cspb_activity_ack_proto_rawDescGZIP(), []int{0}
}
...
func (x *JoinActivityAck) Reset() {
	*x = JoinActivityAck{}
	mi := &file_cspb_activity_ack_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*JoinActivityAck) Descriptor() ([]byte, []int) {
	return file_cspb_activity_ack_proto_rawDescGZIP(), []int{1}
}

func (x *JoinActivityAck) GetCode() pb_common.ErrCode {
	if x != nil {
		return x.Code
	}
...
func (x *GetProgressAck) Reset() {
	*x = GetProgressAck{}
	mi := &file_cspb_activity_ack_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetProgressAck) Descriptor() ([]byte, []int) {
	return file_cspb_activity_ack_proto_rawDescGZIP(), []int{2}
}

func (x *GetProgressAck) GetCode() pb_common.ErrCode {
	if x != nil {
		return x.Code
	}
	return pb_common.ErrCode(0)
...
func (x *ClaimRewardAck) Reset() {
	*x = ClaimRewardAck{}
	mi := &file_cspb_activity_ack_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClaimRewardAck) Descriptor() ([]byte, []int) {
	return file_cspb_activity_ack_proto_rawDescGZIP(), []int{3}
}

func (x *ClaimRewardAck) GetCode() pb_common.ErrCode {
	if x != nil {
		return x.Code
	}
	return pb_common.ErrCode(0)
...
var File_cspb_activity_ack_proto protoreflect.FileDescriptor

const file_cspb_activity_ack_proto_rawDesc = "" +
	"\n" +
	"\x17cspb/activity/ack.proto\x1a\x1acspb/activity/struct.proto\x1a\x15cspb/comm/error.proto\"C\n" +
	...
	"\x04code\x18\x01 \x01(\x0e2\b.ErrCodeR\x04code\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\tR\x03msgB,Z*github.com/gogu-x/gogs/pb/cspb/pb_activityb\x06proto3"

var (
	file_cspb_activity_ack_proto_rawDescOnce sync.Once
	file_cspb_activity_ack_proto_rawDescData []byte
)

func file_cspb_activity_ack_proto_rawDescGZIP() []byte {
	file_cspb_activity_ack_proto_rawDescOnce.Do(func() {
		file_cspb_activity_ack_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cspb_activity_ack_proto_rawDesc), len(file_cspb_activity_ack_proto_rawDesc)))
	})
	return file_cspb_activity_ack_proto_rawDescData
}

var file_cspb_activity_ack_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_cspb_activity_ack_proto_goTypes = []any{
	...
	(pb_common.ErrCode)(0),     // 5: ErrCode
	(*ActivityProgress)(nil),   // 6: ActivityProgress
}
var file_cspb_activity_ack_proto_depIdxs = []int32{
...
func init() { file_cspb_activity_ack_proto_init() }
func file_cspb_activity_ack_proto_init() {
	if File_cspb_activity_ack_proto != nil {
		return
	}
	file_cspb_activity_struct_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cspb_activity_ack_proto_rawDesc), len(file_cspb_activity_ack_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cspb_activity_ack_proto_goTypes,
		DependencyIndexes: file_cspb_activity_ack_proto_depIdxs,
		MessageInfos:      file_cspb_activity_ack_proto_msgTypes,
	}.Build()
	File_cspb_activity_ack_proto = out.File
	file_cspb_activity_ack_proto_goTypes = nil
	file_cspb_activity_ack_proto_depIdxs = nil
}

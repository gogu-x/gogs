...
func (x *LoginGameReq) Reset() {
	*x = LoginGameReq{}
	mi := &file_gateway_gateway_req_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LoginGameReq) Descriptor() ([]byte, []int) {
	return file_gateway_gateway_req_proto_rawDescGZIP(), []int{4}
}
...
func (x *LoginGameReq) GetServerId() int32 {
	if x != nil {
		return x.ServerId
	}
	return 0
...
const file_gateway_gateway_req_proto_rawDesc = "" +
	...
	"\tserver_id\x18\x02 \x01(\x05R\bserverIdB(Z&github.com/gogu-x/gogs/pb/protoGatewayb\x06proto3"
...
var file_gateway_gateway_req_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_gateway_gateway_req_proto_goTypes = []any{
	...
	(*LoginGameReq)(nil),     // 4: LoginGameReq
}

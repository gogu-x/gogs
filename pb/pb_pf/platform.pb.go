...
func (x *AuthAck) GetCode() pb_common.ErrCode {
	if x != nil {
		return x.Code
	}
...
func (x *ServerListAck) GetCode() pb_common.ErrCode {
	if x != nil {
		return x.Code
	}
	return pb_common.ErrCode(0)
...
func (x *OrderAck) GetCode() pb_common.ErrCode {
	if x != nil {
		return x.Code
	}
	return pb_common.ErrCode(0)
...
const file_platform_platform_proto_rawDesc = "" +
	...
	"\x03uid\x18\x02 \x01(\x04R\x03uid\"t\n" +
	...
	"\n" +
	"QueryOrder\x12\x17.platform.QueryOrderReq\x1a\x15.platform.OrderDetailB!Z\x1fgithub.com/gogu-x/gogs/pb/pb_pfb\x06proto3"
...
var file_platform_platform_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_platform_platform_proto_goTypes = []any{
	...
	(pb_common.ErrCode)(0),   // 14: ErrCode
}
var file_platform_platform_proto_depIdxs = []int32{
	14, // 0: platform.AuthAck.code:type_name -> ErrCode
	14, // 1: platform.ServerListAck.code:type_name -> ErrCode
	7,  // 2: platform.ServerListAck.accounts:type_name -> platform.ServerAccount
	14, // 3: platform.OrderAck.code:type_name -> ErrCode
